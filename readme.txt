===DD Simple Maintenance & Coming Soon Mode - Clean, Easy & 100% Free ===
...
* Login URL (domain/wp-login.php) is Excluded and Also Logged in User (who can edit posts) are Excluded from Maintenance
...
2. Activate the plugin to Enable the Maintenance Mode on Your Website through the 'Plugins' screen in WordPress


== Frequently Asked Questions ==

= Is DD Simplest Maintenance Mode Plugin Free? =
